	...
	<table border="0" style="width:100%;">
		<tr>
			<td style="height:40px">
				<span style="font-weight:bold; color:#1D1FAB; font-size:20px;">공유해요</span>
			</td>
		</tr>						
		<tr>
			<td>
				<table border="0" style="width:85%;border-bottom: 1px solid grey">
					...
					<tr id="tr">
						...
						<th style="background-color:#E8F2FE; height:40px;">제목</th>
						<th style="background-color:#E8F2FE; width: 100px; height:40px;">작성자</th>
						<th style="background-color:#E8F2FE; width: 100px; height:40px;">작성일</th>	
						<th style="background-color:#E8F2FE; width: 80px; height:40px;">조회수</th>							
					</tr>
					<%
						//where 구문을 작성한다.
						String where = "";
		...
		<tr>
			...
			<%
				...
				{
					%><a href="../write/comwrite.jsp" id="write">글쓰기</a><%
				}
			%>
