...
<td>
	...
	<tr>
		<td style="padding:10px 10px 30px 30px">
			<span style="font-weight:bold; colo	r:#1D1FAB; font-size:20px;">글수정</span>
		</td>
	</tr>
	</table>		
	<form name="commodify" method="post" action="../modify/commodifyok.jsp" onsubmit="return DoCheck();" enctype="multipart/form-data">
