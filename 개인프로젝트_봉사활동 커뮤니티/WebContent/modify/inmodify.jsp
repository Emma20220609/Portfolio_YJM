...
<%
	//---------------------게시물 자료를 조회 -----------------------------------
	String sql="";
	sql  = "select board_no,user_no,board_title,board_loca,board_province,board_city, ";
	sql += "board_phone,board_type,board_note,board_start,board_end,board_proc ";
	sql += "from board ";
...
<td>
	...
	<form name="inmodify" method="post" action="../modify/inmodifyok.jsp" onsubmit="return DoCheck();" enctype="multipart/form-data">
		...
		<table border="0" style="width:85%; margin:0px 0px 0px 0px;padding:0px 0px 0px 0px ; border: 1px;">
			...
			<tr>
				...
				<td><input type="text" name="phone" style="width:95%"  value=<%= board_phone %>></td>
			</tr>
			<tr>
