...
<td>
	...
	<form id="inwrite" name="inwrite" method="post" action="../write/inwriteok.jsp" onsubmit="return DoCheck();" enctype="multipart/form-data">
		<table border="0" style="width:85%; margin:0px 0px 0px 0px;padding:0px 0px 0px 0px ; border: 1px;">
			...
			<tr>
				<td style="text-align:center;" colspan="2">
					...
					<a id="loginbtn"  href="../board/index.jsp">취소</a>
