...
<td>
	...
	<form name="nowrite" method="post" action="../write/nowriteok.jsp" onsubmit="return DoCheck();" enctype="multipart/form-data">
		<input type="hidden" id="board_type" name="board_type" value="N">
		<table border="0" style="width:85%; margin:0px 0px 0px 0px;padding:0px 0px 0px 0px ; border: 1px;">
			...
			<tr>
				<td style="text-align:center;" colspan="2">
					...
					<a id="loginbtn"  href="../board/notice.jsp">취소</a>
