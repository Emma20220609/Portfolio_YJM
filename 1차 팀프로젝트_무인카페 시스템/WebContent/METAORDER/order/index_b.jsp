...
%>
			...
			for(int i=0; i < size; i++)
			{
				...
				%>
					<tr>
						<td style="width:125px; height:80px">
							<a href="view.jsp?hname=<%= vo.getDef_hname() %>"><img width="125px"src="https://www.paris.co.kr/wp-content/uploads/%E1%84%8B%E1%85%A1%E1%84%86%E1%85%A6%E1%84%85%E1%85%B5%E1%84%8F%E1%85%A1%E1%84%82%E1%85%A9-1280x1280.jpg"></a>
						</td>
						<td colspan="3">
							<a href="view.jsp?hname=<%= vo.getDef_hname() %>"><%= vo.getDef_hname() %></a>
						</td>
					</tr>
				<%
			}
