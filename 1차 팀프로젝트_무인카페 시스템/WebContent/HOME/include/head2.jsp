	...
	<div id="header">
		<div class="h_inner" style="padding-bottom: 0px;">
			...
			<div class="gnb_wrap" id="gnb_wrap">
				<ul class="gnb">
					<li><a href="about1.jsp">About us</a>
						<ul class="gsnb">
							<li><a href="about1.jsp">Brand</a></li>
							<li><a href="about2.jsp">Coffee</a></li>
						</ul>
					</li>
					<li><a href="menu.jsp">MENU</a></li>
					<li><a href="store.jsp">SHOP</a>
						<ul class="gsnb">
							<li><a href="store.jsp">매장위치안내</a></li>
						</ul>
					</li>
					<li><a href="contact.jsp">Contact</a>
						<ul class="gsnb">
							<li><a href="../board/bindex.jsp">공지사항</a></li>
							<li><a href="contact.jsp">이메일 문의하기</a></li>
						</ul>
					</li>
