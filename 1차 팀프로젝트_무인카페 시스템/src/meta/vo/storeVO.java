...
public class storeVO {
	...
	private	Date	st_open;	//오픈타임
	private	Date	st_close;	//폐점타임
	...
	public	Date	getSt_open()	{ return st_open;	}
	public	Date	getSt_close()	{ return st_close;	}
	...
	public	void	setSt_open(	Date	st_open	) { this.st_open  = st_open;	}
	public	void	setSt_close(Date	st_close) { this.st_close = st_close;	}
	public	void	setSt_off(	String	st_off	) { this.st_off	  = st_off;		}
	public	void	setSt_holy(	String	st_holy	) { this.st_holy  = st_holy;	}
	
	public void info() {
		System.out.println("store info " + this.getSt_no());
		System.out.println("store info " + this.getSt_name());
		System.out.println("store info " + this.getSt_adr());
		System.out.println("store info " + this.getSt_open());
	}
}
