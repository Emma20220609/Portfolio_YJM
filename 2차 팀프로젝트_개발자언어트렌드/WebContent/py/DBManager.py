...
#		print(sql)
	...
	def setWhere(
		#[[==========================================
		# SQL 구문에서 where, order by, limit 부분을 작성한다.
		self,
		where		= None,
		where_value	= None,
		orderby		= None,
...
''' 사용 방법
# 학원 교실에서 내부 서버 DB를 이용할때
db = DBManager("192.168.0.200")
# 팀 프로젝트용 외부 서버 DB를 이용할때
db = DBManager()
