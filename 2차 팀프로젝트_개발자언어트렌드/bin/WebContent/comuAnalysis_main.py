"""
작성자 : 함경환
작성일 : 2022년 6월 29일 오후 12시 30분
"""

import DBManager as DB
import pandas as pd
import numpy as np
import comuAnalysis as CA
...
class comuAnalysis_main :
	...
	# 생성자 comuAnalysis 용으로 기본 값을 넣는다
		self.parse_data_table_name	= "comuList"
		self.column_name			= column_name
		self.column_value			= column_value
		self.target_table_name		= "comuAnalysis"
	...
	#	print(self.parse_data_list)
		...
		#생성자
		ca = CA.comuAnalysis()
		list_to_recAnalysis = ca.main("contents", list_to_recAnalysis)
		print("="*50)
	#	print(list_to_recAnalysis)
		self.insert_DB(list_to_recAnalysis)
	#===========================================================================================

kldp		= comuAnalysis_main("comu_name","kldp")
devsnote	= comuAnalysis_main("comu_name","devsnote")
devsnote_w	= comuAnalysis_main("comu_name","devsnote_w")

devsnote_w.main()
devsnote.main()
# kldp.Do_main("comu_name","kldp")